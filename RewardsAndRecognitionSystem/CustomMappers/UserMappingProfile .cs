    ...
    public class UserMappingProfile : Profile
    {
        public UserMappingProfile()
        {
            ...
            CreateMap<User, UserViewModel>()
               ...
               .ForMember(dest => dest.PasswordHash, opt => opt.Ignore()) // Do not map PasswordHash back to ViewModel
               .ForMember(dest => dest.SelectedRole, opt => opt.Ignore()); // Role handled separately : null));
        }
    }
}
